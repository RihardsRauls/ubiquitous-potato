<x-layout>
    ...
    <form action="{{ route('listing.update', $listing->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="title" name="title" value="{{ old('title', $listing->title) }}" class="form-control @error('title') is-invalid @enderror">
        ...
        <div class="mb-3">
            ...
            <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror">{{ old('description', $listing->description) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="company_name" name="company_name" value="{{ old('company_name', $listing->company_name) }}" class="form-control @error('company_name') is-invalid @enderror">
        ...
        <div class="mb-3">
            ...
            <input type="number" id="salary" name="salary" value="{{ old('salary', $listing->salary) }}" class="form-control @error('salary') is-invalid @enderror">
